...
| `200 Event received` but expected loyalty activity is missing | The webhook restaurant identifier, customer phone, or refund linkage needs review | Confirm `external_location_id`, customer phone, and original sale identifier. | Correct the data or confirm the connected restaurant binding with Samparka. |
