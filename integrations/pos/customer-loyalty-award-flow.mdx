...
<Info>
**Also see — Purchase QR**. When the POS creates the QR session itself (rather than staff using the dashboard), the customer still onboards on scan & claim. See the [Purchase QR Overview](/integrations/pos/purchase-qr/overview).
</Info>
