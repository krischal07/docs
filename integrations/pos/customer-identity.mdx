...
<Info>
**Also see — Purchase QR**. The QR checkout requires a valid `customer_phone` as the WhatsApp deep-link target. See the [Purchase QR Integration Guide](/integrations/pos/purchase-qr/integration-guide).
</Info>
