...
| `200 Event received` but expected loyalty activity is missing | The location mapping, customer phone, or refund linkage needs review | Confirm `restaurantId`, customer phone, and original sale identifier. | Correct the data or confirm the outlet mapping with Samparka. |
